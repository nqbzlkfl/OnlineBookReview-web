...
<body class="antialiased bg-gray-100">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-blue-800 shadow-sm ">
            <div class="container md:mx-18 lg:mx-20">
                <a class="navbar-brand inline-flex text-white font-semibold hover:opacity-95" href="{{ url('/') }}">
                    ...
                    <h1 class="my-auto pt-0 text-yellow-400" style="font-family:Varela Round;">Book</h1>
                    <h1 class="my-auto pt-0 text-white" style="font-family:Varela Round;">Review</h1>
                </a>
                <!-- <div class="w-10 h-10">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white pl-2 md:transform scale-100 font-normal hover:scale-110 hover:font-bold" 
                               href="{{ url('book-list') }}">{{ __('Book') }}</a>
                        </li>
                        <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle pl-2 md:transform scale-100 hover:scale-110 inline-flex text-md text-white my-auto items-center" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ __('Category') }}
                                </a>
                    ...
                    <ul class="navbar-nav ml-auto space-x-2">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle md:transform scale-100 hover:scale-110 inline-flex text-md text-white my-auto items-center" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <h1 class="hover:">Account&nbsp</h1><h1 class="text-lg"><i class="fas fa-user-circle scale-110"></i></h1>
                                </a>
    ...
    <main class="h-auto py-0 bg-gray-100 md:mx-18 lg:mx-24">
        @yield('content')
    </main>
    </div>
                ...
                <div class="px-0 pt-2 flex flex-col md:mx-auto justify-center">
                    <div class="sm:mt-0 mb-2 sm:w-full flex flex-col md:flex-row md:mx-auto md:w-full justify-between md:justify-center space-y-4 md:space-y-0 md:space-x-12">
                        ...
                        <div class="flex flex-col md:w-64">
                            ...
                            <a class="hover:no-underline hover:text-blue-700 w-4/12" href="{{ url('shop-list') }}"  >
                                <p class="text-md mb-1 font-semibold">
                                    Shop here
                                </p>
                            </a>
                ...
                <div class="mt flex flex-col items-center">
                    ...
                    <img class="pointer-events-none mx-4 h-9 w-9 flex mx-auto mb-2 fill-current text-green-600" src="{{ asset('img/nqbzlkfl-w.png') }}" alt="Brand">
                        <p class="text-xs font-semibold mx-2">
                            © 2021 BookReview. All rights reserved. | Privacy Policy | <a class="hover:no-underline hover:text-blue-300" href="https://www.linkedin.com/in/naqibzulkifli/" target="_blank">Contact</a>
                        </p>
                        <p class="text-xs font-semibold mx-2">

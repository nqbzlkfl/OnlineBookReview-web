    ...
    <div class=" pb-2 lg:pb-0 w-full lg:max-w-xs px-3 flex flex-row lg:flex-col md:fl flex-wrap lg:flex-nowrap my-3">
        ...
        <div class="w-full h-24 min-h-0 min-w-0">
            ...
            <div class="bg-white border h-92 p-2" title="category" style="font-family:Mukta">
                <div class="py-1">
                    <img class="h-46 w-72 px-2 bg-cover bg-center pointer-events-none" src="{{ asset('img/books/new5.jpg') }}" alt="avatar">
                </div>
            </div>
    ...
    <div class="h-full w-auto lg:flex-1 px-3 my-3 min-h-0 min-w-0">
        ...
        <div class="bg-gray-100 h-full min-h-0 min-w-0 overflow-auto my-auto">
            ...
            <div class="bg-white border h-auto max-h-96 mb-2 overflow-x-scroll">
                ...
                @foreach($review2 as $r2)
                    <div class="flex-col border bg-blue-50 rounded-sm p-2 my-2" style="font-family:Mukta">
                        <div class="flex flex-row">
                            <h1 class="text-md mb-2 text-gray-800">By&nbsp <h1 class="font-semibold">{{$r2->rName}}</h1></h1>
                        </div>
                        <div class="flex flex-row">
                            <h1 class="text-md mb-2 text-gray-800">Rate: {{$r2->rRate}}/5 &nbsp <h1 class="text-yellow-500"><i class="fas fa-star"></i></h1></h1>
                        </div>
                        <h1 class="text-md text-gray-800">Review:</h1>
                        <p class="text-md mb-2 text-gray-800 bg-gray-50 rounded-md border p-1">{{$r2->rComment}}</p>
                        <div class="flex flex-row">
                            <h1 class="text-md mb-2 text-gray-800">Suggestion:&nbsp<h1 class="font-semibold">{{$r2->rSuggestion}}</h1></h1>
                        </div>
                    </div>
                @endforeach
                </div>
                ...
                <div class="flex my-3 m-2">
                    <div class="flex-1 flex-col items-start top-0 pl-2 my-2 mx-4 justify-between" style="font-family:Mukta">
                        @guest
                            ...
                            @endif
                        @else
                        <form method="POST" action="/book/Eternals_2021">
                            @csrf
                            ...
                            <input type="hidden" name="bName" id="bName" value="Eternals (2021-) #1">
